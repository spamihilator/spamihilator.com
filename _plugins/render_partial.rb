...
module Jekyll
  ...
  class RenderPartialTag < Liquid::Tag
    ...
    def render(context)
      ...
      file_dir = context.registers[:site].source + '/_includes'
  ...
  class RenderPartialLangTag < RenderPartialTag
    def render(context)
      if context.environments.first["page"]["lang"] == 'de'
        @file = 'de/' + @file
      else
        @file = 'en/' + @file
      end
...
Liquid::Template.register_tag('render_partial_lang', Jekyll::RenderPartialLangTag)
